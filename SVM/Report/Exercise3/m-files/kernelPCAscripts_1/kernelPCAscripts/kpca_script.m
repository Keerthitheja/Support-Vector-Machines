...
% plot dataset
h=figure; hold on
plot(samplesyin(:,1),samplesyin(:,2),'o','MarkerSize',15);
plot(samplesyang(:,1),samplesyang(:,2),'o','MarkerSize',15);
xlabel('X_1');
ylabel('X_2');
...
for nc=componentsList
    ...
    %h2=figure;
    h = plot(samplesyin(:,1),samplesyin(:,2),'go','MarkerSize',15);
    h1 = plot(samplesyang(:,1),samplesyang(:,2),'bo','MarkerSize',15);
    h2 = plot(xd(:,1),xd(:,2),'r+','MarkerSize',20);
